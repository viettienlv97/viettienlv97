...
USER_NAME = os.environ['USER_NAME'] # 'viettienlv97'
...
if __name__ == '__main__':
    ...
    # TODO: update this to your real birthday (year, month, day)
    age_data, age_time = perf_counter(daily_readme, datetime.datetime(1997, 1, 1))
